...
서버에 등록된 프로젝트 목록을 표시하고, 작업 대상 프로젝트를 선택하는 진입 페이지.
...
- **프로젝트 선택**
  - 카드 클릭 시 해당 프로젝트 context로 대시보드(`/`)로 이동한다.
  - 선택된 프로젝트 정보는 상단 글로벌 헤더에 표시된다.

- **프로젝트 전환**
  - 상단 헤더의 프로젝트 이름을 클릭하면 프로젝트 선택 페이지로 돌아갈 수 있다.
  - 현재 선택된 프로젝트가 헤더에 항상 표시되어 어떤 프로젝트를 보고 있는지 명확히 알 수 있다.
